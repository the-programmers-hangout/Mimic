...
public class MessagesRecord extends UpdatableRecordImpl<MessagesRecord> implements Record4<Long, Long, String, Long> {
    ...
    @Override
    public MessagesRecord values(Long value1, Long value2, String value3, Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessagesRecord(Long messageid, Long userid, String content, Long channelid) {
        super(Messages.MESSAGES);
